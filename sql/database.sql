...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th8 31, 2025 lúc 05:23 PM
...
('23ae4282-309d-4b8a-81de-12b3292427d6', 'STANDAR', 'ba0df91b-21b9-429a-bc1f-d86830c3f447', 150000.00, 100, 0, '2025-08-31 15:08:31', '2025-08-31 15:23:03'),
...
('663401f4-5399-4aee-9281-fd2da0b4a515', 'VIP', 'ba0df91b-21b9-429a-bc1f-d86830c3f447', 1000000.00, 0, 0, '2025-08-31 15:23:03', '2025-08-31 15:23:03'),
...
--
DELIMITER $$
CREATE TRIGGER `update_event_min_price_after_ticket` AFTER INSERT ON `tickets` FOR EACH ROW BEGIN
    UPDATE events e
    JOIN (
        SELECT z.event_id, MIN(t.price) AS min_price
        FROM tickets t
        JOIN zones z ON t.zone_id = z.id
        GROUP BY z.event_id
    ) t_min ON e.id = t_min.event_id
    SET e.min_price = t_min.min_price;
END
$$
DELIMITER ;
...
('ba0df91b-21b9-429a-bc1f-d86830c3f447', '897adc82-cd65-4ad3-a6a0-9cc7d75d5e35', 'CAT 1', 'SEAT', 'Khu vực phía bên trái sân khấu', 100, '2025-08-31 13:33:04', '2025-08-31 15:08:31'),
